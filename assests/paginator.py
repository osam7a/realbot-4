...
l = {
  "backwards":":arrow_left:",
  "fastbackwards":":arrow_backward:",
  "forwards":":arrow_right:",
  "fastforwards":"arrow_forward",
  "close":":wastebasket:"
}
...
class Paginator:
    ...
    async def paginate(self, **kwargs):
        ...
        embed = discord.Embed(
            ...
            name=name,
            icon_url=icon_url if icon_url else self.ctx.author.avatar_url
        ).set_footer(
